...
(function () {
  ...
  const translations = {
    fr: {
      ...
      'about-title': 'Une Fondation.<br>Une Mission.',
      ...
      'stat-4-label': '2 sites à Kinshasa',
      ...
      'tl-4-year': '2025',
      'tl-4-title': 'Centre opérationnel — 2 sites à Kinshasa',
      'tl-4-text': 'Ouverture de 2 sites opérationnels à Kinshasa. Distribution de plus de 15 000 repas. Base solide pour le déploiement national et continental du plan 2026–2030.',
      ...
      'prog-a-title': 'École &amp; Programmes pour enfants (3–12 ans)',
      'prog-a-desc': 'École, alphabétisation, nutrition, éveil, activités créatives et valeurs fondamentales pour les plus petits. Chaque enfant mérite le meilleur départ dans la vie.',
      ...
      'goal-3': 'Multiplier les écoles et centres de formation à Kinshasa',
      ...
      'gallery-cap-5': 'Servir avec amour, chaque semaine',
      'gallery-cap-6': 'L\'équipe CDA au cœur de l\'action',
      'gallery-cap-7': 'Des bénévoles engagés, chaque jour',

      /* ---- DONATION ---- */
      'donation-label': 'Agir maintenant',
      'donation-title': 'Ensemble, transformons<br>une génération.',
      'donation-body': 'Toutes les informations pour effectuer votre virement sont disponibles ci-dessous.',
    ...
    en: {
      ...
      'about-title': 'One Foundation.<br>One Mission.',
      ...
      'stat-4-label': '2 sites in Kinshasa',
      ...
      'tl-4-year': '2025',
      'tl-4-title': 'Operational centre — 2 sites in Kinshasa',
      'tl-4-text': 'Opening of 2 operational sites in Kinshasa. Distribution of over 15,000 meals. A solid base for the national and continental rollout of the 2026–2030 plan.',
      ...
      'prog-a-title': 'School &amp; Programmes for children (ages 3–12)',
      'prog-a-desc': 'School, literacy, nutrition, early learning, creative activities and core values for the youngest. Every child deserves the best start in life.',
      ...
      'goal-3': 'Multiply schools and training centres in Kinshasa',
      ...
      'gallery-cap-5': 'Serving with love, every week',
      'gallery-cap-6': 'The CDA team in action',
      'gallery-cap-7': 'Committed volunteers, every day',

      /* ---- DONATION ---- */
      'donation-label': 'Act now',
      'donation-title': 'Together, let us transform<br>a generation.',
      'donation-body': 'All the information to make your bank transfer is available below.',
